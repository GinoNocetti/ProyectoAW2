    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ${NavElements.map(e => `
                    <li class="nav-item">
                        <a class="nav-link disabled" data-link="${e.link}">${e.title}</a>
                    </li>
                `).join('')}
            </ul>
            <div class="ms-auto">
                <form class="d-flex" role="search">
                    ...
                    <a href="../index.html" id="logoutBtn" class="btn btn-outline-danger custom-btn-close d-flex align-items-center"><i class="bi bi-box-arrow-right"></i></a>
                    </form>
            </div>
        </div>
    </div>
